...
if(isset($_POST['lectureAddBtn'])){
   if(empty($_POST['clecDescription'])){
    ...
    if (!isset($_SESSION['errors']) || count($_SESSION['errors']) == 0) {
     ...
     $sql = "INSERT INTO `tbl_course_lecture` ( `clec_audiofile`, `clec_notesfile`, `clec_description`,`clecture_teacherId`, `clecture_courseId` ) VALUES ( '$clecfile', '$clecNotes','$clecDescription', '$teacherID',  '$courseID')";
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" name="addCourseLec.php?" class="forms-sample" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      <label for="clecDescription"  class="col-sm-3 col-form-label">Description</label>
                      <div class="col-sm-9">
                        <textarea name="clecDescription" class="form-control"><?php echo $clecDescription; ?></textarea>
                      </div>
                    </div>
                    
                    <button type="submit" name="lectureAddBtn" class="btn btn-primary mr-2">Submit</button>
